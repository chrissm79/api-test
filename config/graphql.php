...
return [
    ...
    'middleware' => [ 'auth:api', 'scope:graphql' ],
//    'middleware' => [ 'auth:api', 'scopes:graphql'],
    ...
    'schemas' => [
        'default' => [
            'query' => [
                'platforms' => App\GraphQL\Query\PlatformsQuery::class
            ],
            'mutation' => [
                'insertPlatform' => App\GraphQL\Mutation\InsertPlatformMutation::class,
                'updatePlatformServer' => App\GraphQL\Mutation\UpdatePlatformServerMutation::class
            ]
        ]
    ],
    */
    ...
    /*
    'types' => [
        'platform' => \App\GraphQL\Type\PlatformType::class
    ],
    */
